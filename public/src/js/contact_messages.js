...
function deleteContactMessage(event){
	...
	ajax("GET", "http://homestead.app:8000/admin/contact/message/delete/" + messageId, null, messageDeleted, [event.path[5]]);
}
...
http.onreadystatechange = function() {
    if(http.readyState == XMLHttpRequest.DONE) {
        if(http.status == 200) {
            ...
            alert('Contact could not be saved. Please try again.');
