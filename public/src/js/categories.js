...
ajax( 'POST', "http://homestead.app:8000/admin/blog/category/create", "name=" + name, newCategoryCreated, [name] );
...
function saveEdit(event) {
    ...
    ajax('POST', "http://homestead.app:8000/admin/blog/category/update", "name=" + categoryName + "&category_id=" + CategoryId, endEdit, [event]);
}
...
function deleteCategory(event){
    ...
    ajax('GET' ,"http://homestead.app:8000/admin/blog/category/delete/" + CategoryId, null, categoryDeleted, [event.path[5]] );
}
